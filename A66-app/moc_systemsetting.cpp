...
**
** Created: Thu Aug 25 10:40:39 2016
...
int SystemSetting::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: openSystemSettingWin(); break;
        case 1: timerEvent((*reinterpret_cast< QTimerEvent*(*)>(_a[1]))); break;
        case 2: on_treeWidget_System_itemSelectionChanged(); break;
        case 3: on_tableWidget_System_cellChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 4: on_toolButton_readConfig_clicked(); break;
        case 5: on_toolButton_confirm_clicked(); break;
        default: ;
        }
        _id -= 6;
    }
