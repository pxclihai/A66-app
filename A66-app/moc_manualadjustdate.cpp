...
**
** Created: Thu Aug 25 10:40:51 2016
...
const QMetaObject ManualAdjustDate::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ManualAdjustDate,
      qt_meta_data_ManualAdjustDate, 0 }
};
...
int ManualAdjustDate::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: sig_sndManualX((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: sig_sndManualY((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: sig_sndManualR((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 3: on_toolButton_clicked(); break;
        case 4: on_toolButton_2_clicked(); break;
        case 5: on_toolButton_3_clicked(); break;
        default: ;
        }
        _id -= 6;
    }
